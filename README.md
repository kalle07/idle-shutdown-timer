...
<br>
Useful for anyone who, for example, starts a long download, a simulation, or a training session, so that the computer shuts down, say, 5 minutes after the task is completed.<br><br>
